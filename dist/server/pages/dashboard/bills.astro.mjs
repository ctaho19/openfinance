...
import 'piccolore';
import { L as Link, $ as $$DashboardLayout } from '../../chunks/DashboardLayout_Ydptwcmz.mjs';
import { B as Button, C as Card, c as CardContent, a as CardHeader, b as CardTitle, S as StatCard } from '../../chunks/button_D1bppc5j.mjs';
import { jsxs, jsx, Fragment } from 'react/jsx-runtime';
import { useState } from 'react';
import { S as SearchInput } from '../../chunks/search-input_DAvPwjoS.mjs';
import { MoreVertical, Pencil, Power, Trash2, ChevronDown, ChevronRight, Check, Clock, Receipt, Plus, ShoppingBag, FileText, CreditCard, ShieldCheck, Landmark, Zap, Tv, Calendar, TrendingDown } from 'lucide-react';
...
Add Bill
</a> </header> <div class="grid grid-cols-1 md:grid-cols-3 gap-4"> ${renderComponent($$result2, "StatCard", StatCard, { "client:visible": true, "label": "Monthly Recurring", "value": `$${totalMonthly.toLocaleString(void 0, { minimumFractionDigits: 2 })}`, "icon": Receipt, "variant": "info", "client:component-hydration": "visible", "client:component-path": "/Users/chris/projects/dev/openfinance/src/components/ui/card", "client:component-export": "StatCard" })} ${renderComponent($$result2, "StatCard", StatCard, { "client:visible": true, "label": "BNPL Remaining", "value": `$${totalBNPLRemaining.toLocaleString(void 0, { minimumFractionDigits: 2 })}`, "icon": CreditCard, "variant": "warning", "client:component-hydration": "visible", "client:component-path": "/Users/chris/projects/dev/openfinance/src/components/ui/card", "client:component-export": "StatCard" })} ${renderComponent($$result2, "StatCard", StatCard, { "client:visible": true, "label": "Active Bills", "value": totalBillCount.toString(), "icon": TrendingDown, "variant": "success", "client:component-hydration": "visible", "client:component-path": "/Users/chris/projects/dev/openfinance/src/components/ui/card", "client:component-export": "StatCard" })} </div> ${renderComponent($$result2, "BillsList", BillsList, { "client:load": true, "regularBills": regularBills, "bnplGroups": bnplGroups, "client:component-hydration": "load", "client:component-path": "@/components/bills/bills-list", "client:component-export": "BillsList" })} </div> ` })}`;
