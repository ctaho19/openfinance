import { e as createComponent, f as createAstro, k as renderComponent, l as renderScript, r as renderTemplate, m as maybeRenderHead } from '../chunks/astro/server_CLo6n4dC.mjs';
import 'piccolore';
import { $ as $$BaseLayout } from '../chunks/BaseLayout_BqOSQ8w0.mjs';
...
Show
</button> </div> </div> <div class="flex items-center justify-between text-sm"> <label class="flex items-center gap-2 cursor-pointer"> <input type="checkbox" class="w-4 h-4 rounded border-gray-300 text-[#0060f0] focus:ring-[#0060f0]"> <span class="text-gray-600">Remember me</span> </label> </div> <button type="submit" id="submit-btn" class="w-full py-3 bg-[#0060f0] hover:bg-[#004dc0] text-white rounded-lg font-semibold transition-colors disabled:opacity-50">
Sign in
</button> </form> <div class="mt-6 pt-5 border-t border-gray-200 text-sm"> <span class="block text-gray-500">
Contact support to reset password
</span> </div> </div> </div> </main> <!-- Footer --> <footer class="py-6 border-t border-gray-200 bg-white"> <div class="max-w-7xl mx-auto px-6 text-center text-sm text-gray-500">
